...
const HomeIllustration: FC<HomeIllustrationProps> = ({ imageSrc, label, className = '' }) => {
  return (
    <div className={classNames(className, 'home-illu')}>
      <div>
        <img src={imageSrc} className="w-[220px] mx-auto" />
      </div>
      <div className="font-bold text-2xl leading-7 mt-6 max-w-[296px] mobile:paragraph">
        {label}
      </div>
    </div>
  );
  ...
  return (
    <div className="hippo-home text-center mx-auto  max-w-[1570px]">
      <div className="hippo-home__about mb-56">
        <SubTitle>About Hippo</SubTitle>
        <div className="font-bold text-[80px] mb-24 laptop:text-[68px] tablet:text-[56px] mobile:h5">
          We are the aggregation layer for Aptos DeFi & Open Source Development
        </div>
        <div className="flex justify-evenly items-center tablet:flex-col tablet:gap-y-8">
      ...
      <div className="hippo-home__offerings mb-56">
        <SubTitle>Our Offerings</SubTitle>
        <div className="h1 mb-24 max-w-[1108px] mx-auto mobile:h5">
